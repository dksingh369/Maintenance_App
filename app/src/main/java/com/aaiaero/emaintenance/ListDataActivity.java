            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    switch (receivedData[1]) {
                        ...
                        case "NavAidsNDBSAC500QuarterlyActivity": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this, NavAidsNDBSAC500QuarterlyActivity.class);
                        ...
                        case "NavAidsNDBSAC500MonthlyActivity": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this, NavAidsNDBSAC500MonthlyActivity.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "NavAidsNDBSAC500WeeklyActivity": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this, NavAidsNDBSAC500WeeklyActivity.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "NavAidsNDBSAC500DailyActivity": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this, NavAidsNDBSAC500DailyActivity.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "NavAidsNDBAmplidon15770Daily": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,NavAidsNDBAmplidon15770Daily.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "NavAidsNDBAmplidon15770Weekly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,NavAidsNDBAmplidon15770Weekly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "NavAidsNDBAmplidon15770Monthly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,NavAidsNDBAmplidon15770Monthly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINMCCpremonsoon": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINMCCpremonsoon.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINMCCSixMonthly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINMCCSixMonthly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINMCCMonthly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINMCCMonthly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINMCCDaily": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINMCCDaily.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINRESpremonsoon": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINRESpremonsoon.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINRESSixMonthly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINRESSixMonthly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINRESMonthly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINRESMonthly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINRESWeekly": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINRESWeekly.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GAGANINRESDaily": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this,GAGANINRESDaily.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                       ...
                       case "NavAidsNDBSAC100WeeklyActivity": //Add all activities here in the case
                        ...
                        case "DatisSistekDailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, DatisSistekDailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "VHFDVRRetiaMonthlyActivity": //Add all activities here in the case
                            editScreenIntent = new Intent(ListDataActivity.this, VHFDVRRetiaMonthlyActivity.class);
                            editScreenIntent.putExtra("id", itemID);
                            editScreenIntent.putExtra("name", receivedData[0]);
                            editScreenIntent.putExtra("editTextData", receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "LlzNormarc7000WeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000WeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "LlzNormarc7000MonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000MonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc7000QuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000QuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc7000SixActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000SixActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc7000AnnualActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000AnnualActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc7000WfrActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000WfrActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc7000MfrActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc7000MfrActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GpNormarc7000DailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc7000DailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GpNormarc7000WeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc7000WeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GpNormarc7000QuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc7000QuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GpNormarc7000SixActivity":
                            editScreenIntent = new Intent(ListDataActivity.this,GpNormarc7000SixActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GpNormarc7000AnnualActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc7000AnnualActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "LlzNormarc35DailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35DailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc35WeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35WeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc35MonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35MonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc35QuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35QuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc35SixActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35SixActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc35AnnualActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35AnnualActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "LlzNormarc35DfrActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, LlzNormarc35DfrActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GpNormarc35DailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc35DailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GpNormarc35WeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc35WeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GpNormarc35QuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GpNormarc35QuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GpNormarc35SixActivity":
                            editScreenIntent = new Intent(ListDataActivity.this,GpNormarc35SixActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "GaganInlusWestDailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusWestDailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusWestWeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusWestWeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusWestMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusWestMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusWestQuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusWestQuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusWestSixMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusWestSixMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusWestPreMonsoonActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusWestPreMonsoonActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusEastDailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusEastDailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusEastWeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusEastWeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusEastMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusEastMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusEastQuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusEastQuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusEastSixMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusEastSixMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                            ...
                            startActivity(editScreenIntent);
                            break;
                        case "GaganInlusEastPreMonsoonActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, GaganInlusEastPreMonsoonActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "AsmgcsSaabDailyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, AsmgcsSaabDailyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "AsmgcsSaabWeeklyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, AsmgcsSaabWeeklyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "AsmgcsSaabMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, AsmgcsSaabMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "AsmgcsSaabSixMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, AsmgcsSaabSixMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "AsmgcsSaabYearlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, AsmgcsSaabYearlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                      ...
                      /*  case "SurAdsbComsoftMonthlyActivity":
                        ...
                        case "SurAdsbComsoftUpsMonthlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, SurAdsbComsoftUpsMonthlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
                        ...
                        case "SurAdsbComsoftQuarterlyActivity":
                            editScreenIntent = new Intent(ListDataActivity.this, SurAdsbComsoftQuarterlyActivity.class);
                            editScreenIntent.putExtra("id",itemID);
                            editScreenIntent.putExtra("name",receivedData[0]);
                            editScreenIntent.putExtra("editTextData",receivedData[2]);
                            editScreenIntent.putExtra("switchData", receivedData[3]);
